...
const { LEGAL_CONFIG } = require('../../../utils/legal-config');
...
Page({
  ...
  onContact() {
    wx.navigateTo({
      url: '/pkg-extra/me/feedback/index',
      fail() {
        // 兜底：跳转失败时复制运营者联系方式（取自 utils/legal-config.js，不再写死假邮箱）
        copyText(
          LEGAL_CONFIG.operatorContact,
