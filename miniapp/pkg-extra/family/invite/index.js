...
Page({
  ...
  onCopyCode() {
    ...
    copyText(this.data.inviteCode, () => this.showToast('邀请码已复制'), () => this.showToast('复制失败，请重试'));
  },
  ...
  onSaveImage() {
    ...
    copyText(text, () => this.showToast('邀请信息已复制'), () => this.showToast('复制失败，请重试'));
  },
  ...
  onShareAppMessage() {
    ...
    return {
      ...
      path: `/pkg-extra/family/join/index?code=${this.data.inviteCode}`
    };
  },
